    ...
    switch (notification.type) {
      ...
      case NotificationType.MATCH_CREATED:
        if (notification.relatedId) {
          // Could navigate to match details - for now go to home
          navigate('/home');
        }
        break;
      case NotificationType.FRIEND_REQUEST_ACCEPTED:
        navigate('/friends');
        break;
      case NotificationType.USER_LEFT_COMPETITION:
        if (notification.relatedId) {
          navigate(`/competitions/${notification.relatedId}`);
        }
        break;
    }
        ...
        return (
            <div className="w-10 h-10 rounded-full bg-red-100 flex items-center justify-center">
                <svg className="w-5 h-5 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 12H14" />
                </svg>
            </div>
        );
    }
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="p-2 rounded-md relative text-gray-700 hover:text-indigo-600 transition-colors"
